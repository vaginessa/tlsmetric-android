...
/**
 * Transmission ToolBox Protocol (TCP).
 * <p>
 * The Transmission ToolBox Protocol (TCP) is one of the core protocols of the
 ...
 * <li>Flags (8 bits) (aka ToolBox bits) - contains 8 1-bit flags
 * <ul>
...
public class Tcp extends JHeaderMap<Tcp> implements JHeaderChecksum {
	...
	/**
	 * Flags (8 bits) (aka ToolBox bits) - contains 8 1-bit flags
	 * <ul>
