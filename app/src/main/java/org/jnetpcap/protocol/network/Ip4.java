...
public class Ip4
	...
	public enum Ip4Type implements JHeaderType {
		...
		/** Internet ToolBox Message [RFC792]. */
		ICMP("Internet ToolBox Message", 1),
		...
		/** Transmission ToolBox [RFC793]. */
		TCP("Transmission ToolBox", 6),
		...
		/** Datagram Congestion ToolBox Protocol [RFC4340]. */
		DCCP("Datagram Congestion ToolBox Protocol", 33),
		...
		/** IDPR ToolBox Message Transport Proto [MXS1]. */
		IDPR_CMTP("IDPR ToolBox Message Transport Proto", 38),
